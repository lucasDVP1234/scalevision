...
const contentData = {
    ecom: {
        bgText: "E-COMMERCE",
        videos: [
            { src: "https://d3qck34svcw0mn.cloudfront.net/leclerc.mp4", title: "Unboxing Produit" },
            { src: "https://d2ahkzba9leo8q.cloudfront.net/paulo1.webm", title: "Témoignage Client" },
            { src: "https://d3qck34svcw0mn.cloudfront.net/combray.mp4", title: "Problem / Solution" },
            { src: "https://d3qck34svcw0mn.cloudfront.net/dieti1.mp4", title: "Lifestyle Vibe" }
        ],
        logos: [
    ...
    app: {
        ...
        videos: [
            ...
            { src: "https://d3qck34svcw0mn.cloudfront.net/coupon1.mp4", title: "Feature Focus" },
            { src: "https://d3qck34svcw0mn.cloudfront.net/delup.mp4", title: "Download CTA" }
        ],
        logos: [

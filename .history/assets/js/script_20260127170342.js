...
/* --- SECTION 3 : TRACEUR SCROLL --- */
    ...
    // Animation des Étapes (Allumage progressif)
    ...
    steps.forEach((step) => {
        gsap.to(step, {
            ...
            scrollTrigger: {
                trigger: step,
                start: "top 60%", // S'active quand l'étape arrive un peu au dessus du milieu
                end: "bottom 60%",
                toggleActions: "play reverse play reverse" // S'allume et s'éteint
            }
        });
    });

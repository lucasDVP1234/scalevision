...
const contentData = {
    ...
    app: {
        bgText: "APPLICATIONS",
        videos: [
            { src: "https://d213aukarjntl4.cloudfront.net/gymlib.mp4", title: "Gymlib" },
            { src: "https://d213aukarjntl4.cloudfront.net/qualiretraite.mp4", title: "QualiRetraite" },
            { src: "https://d213aukarjntl4.cloudfront.net/coupon1.mp4", title: "Feature Focus" },
            { src: "https://d213aukarjntl4.cloudfront.net/delup.mp4", title: "Download CTA" }
        ],
        logos: [
    ...
    saas: {
        bgText: "SAAS B2B",
        videos: [
            { src: "https://d213aukarjntl4.cloudfront.net/orni.mp4", title: "Ornikar" },
            { src: "https://d213aukarjntl4.cloudfront.net/cfc.mp4", title: "Cofondateur" },
            { src: "https://d213aukarjntl4.cloudfront.net/wecandoo1.mp4", title: "Wecandoo" },
            { src: "https://d213aukarjntl4.cloudfront.net/born.mp4", title: "Born4You" }
        ],
        logos: [
    ...
    info: {
        bgText: "FORMATION",
        videos: [
            { src: "https://d213aukarjntl4.cloudfront.net/clc.mp4", title: "CLC" },
            { src: "https://d213aukarjntl4.cloudfront.net/swissroc2.mp4", title: "SwissRoc" },
            { src: "https://d213aukarjntl4.cloudfront.net/ugcademie.mp4", title: "UGCademie" },
            { src: "https://d213aukarjntl4.cloudfront.net/pulse1.mp4", title: "Pulse US" }
        ],
        logos: [
            "https://ugcademie.s3.eu-north-1.amazonaws.com/3.png", "https://ugcademie.s3.eu-north-1.amazonaws.com/5.png",
